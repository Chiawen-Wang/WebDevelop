   ...
   var hideMarker = $('#hide-listings');
      ...
      function initMap() {
        ...
        map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: 39.871716, lng:116.479379},
          zoom: 13,
          styles: styles,
        ...
        var locations = [
          {title: 'Beijing University of Technology', location: {lat: 39.871716, lng:116.479379}},
          {title: 'HuanLeGu', location: {lat: 39.867835, lng: 116.493981}},
          {title: 'ZhongLan Community', location: {lat: 39.88499, lng: 116.479746 }},
          {title: 'Pingleyuan Community', location: {lat: 39.884005,lng: 116.481268}},
          {title: 'ZhujiangDijing', location: {lat: 39.888214, lng: 116.481671}},
          {title: 'JingSong Dentist', location: {lat: 39.892987,lng:116.473729}},
          {title: 'JianGuo Hotel', location: {lat:39.872007, lng:116.478306}},
          {title: 'JingTi Gym', location: {lat:39.871, lng:116.473097}},
          {title: 'Lala Land', location:{lat:39.867516, lng: 116.47448}},
          {title: 'Beijing DongPai Company', location: {lat: 39.86726, lng: 116.485911}},
          {title: 'Gallery', location: {lat: 39.867376, lng: 116.483607 }}
        ];
        ...
        ko.applyBindings({location : locations});
